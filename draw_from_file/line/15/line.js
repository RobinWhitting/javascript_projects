...
lineData = [
  ...
  // 3rd level
  {x: -lineX, y: -lineY * 7, x2: 0 , y2: -lineY * 2, sep: seperation, t: frameWidth},
  {x: 0, y: -lineY * 6, x2: 0 , y2: -lineY * 2, sep: seperation, t: frameWidth, c: 'red'},
  {x: lineX, y: -lineY * 7, x2: 0 , y2: -lineY * 2, sep: seperation, t: frameWidth},

  {x: 0, y: -lineY * 8, x2: -lineX , y2: -lineY, sep: seperation, t: frameWidth, c: 'blue'},
  {x: 0, y: -lineY * 8, x2: lineX , y2: -lineY, sep: seperation, t: frameWidth, c: 'green'},
  {x: lineX, y: -lineY * 9, x2: -lineX, y2: -lineY, sep: seperation, t: frameWidth},
  {x: -lineX, y: -lineY * 9, x2: lineX, y2: -lineY, sep: seperation, t: frameWidth}
];
...
rectData = [
  ...
  {x1: 0, y1: -lineY * 6, x2: -lineX, y2: -lineY, x3: 0, y3: -lineY * 2, x4: lineX, y4: lineY},
  {x1: 0, y1: -lineY * 6, x2: 0, y2: -lineY * 2, x3: lineX, y3: -lineY, x4: 0, y4: lineY * 2},
  {x1: 0, y1: -lineY * 8, x2: -lineX, y2: -lineY, x3: lineX, y3: -lineY, x4: lineX, y4: lineY}
